...
SYSTEM_PROMPT = (
    ...
    "- DO NOT use parentheses for node shapes if the text inside has any parentheses, slashes, or other special characters. Instead, use double-quoted brackets: `NodeID[\"Text (Nested)\"]`.\n"
    "- DO NOT use semicolons at the end of lines.\n"
    "- Make sure all node IDs are alphanumeric and do not contain spaces.\n"
    "- Ensure all diagrams are syntactically valid.\n"
